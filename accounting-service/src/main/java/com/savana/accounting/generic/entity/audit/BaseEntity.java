package com.savana.accounting.generic.entity.audit;

import com.fasterxml.jackson.annotation.JsonIgnoreProperties;
import com.fasterxml.jackson.annotation.JsonProperty;
import com.savana.accounting.generic.entity.GenericEntity;
...
public abstract class BaseEntity<E, D> implements GenericEntity<E, D>, Serializable {
    ...
    @Id
    private String id;  // MongoDB utilise un ObjectId sous forme de String
